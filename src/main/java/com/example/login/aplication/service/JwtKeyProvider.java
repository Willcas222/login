...
public class JwtKeyProvider {
    ...
    public static RSAPrivateKey getPrivateKey() throws Exception {
        String key = new String(Files.readAllBytes(Paths.get("C:/Users/HUILA/IdeaProjects/login12/private_key.pem")));
    ...
    public static RSAPublicKey getPublicKey() throws Exception {
        String key = new String(Files.readAllBytes(Paths.get("C:/Users/HUILA/IdeaProjects/login12/public_key.pem")));
